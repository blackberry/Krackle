...
public class MessageSetReader
{
	 ...
	 *
	 * This copies the data from the source array, so the source can be altered afterwards with no impact to this class.
	 *
	 * @param src byte array holding the message set.
	 ...
	 *
	 * Ready means that it is initialized and has not reached the end of its data. This does not guarantee that the next request will succeed, since the remaining data could be a truncated message.
	 *
